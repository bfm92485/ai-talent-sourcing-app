...
class BamlAsyncClient:
    ...
    async def ExtractProfile(self, profile_text: str,
        baml_options: BamlCallOptions = {},
    ) -> types.ParsedResume:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            __stream__ = self.stream.ExtractProfile(profile_text=profile_text,
                baml_options=baml_options)
            return await __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ExtractProfile", args={
                "profile_text": profile_text,
            })
            return typing.cast(types.ParsedResume, __result__.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def ExtractProfile(self, profile_text: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.ParsedResume, types.ParsedResume]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractProfile", args={
            "profile_text": profile_text,
        })
        return baml_py.BamlStream[stream_types.ParsedResume, types.ParsedResume](
          __result__,
          lambda x: typing.cast(stream_types.ParsedResume, x.cast_to(types, types, stream_types, True, __runtime__)),
          lambda x: typing.cast(types.ParsedResume, x.cast_to(types, types, stream_types, False, __runtime__)),
          __ctx__,
        )
...
class BamlHttpRequestClient:
    ...
    async def ExtractProfile(self, profile_text: str,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ExtractProfile", args={
            "profile_text": profile_text,
        }, mode="request")
        return __result__
    async def ExtractResume(self, resume_text: str,
