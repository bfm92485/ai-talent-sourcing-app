...
class BamlSyncClient:
    ...
    def ExtractProfile(self, profile_text: str,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ExtractProfile", args={
...
class BamlStreamClient:
    ...
    def ExtractProfile(self, profile_text: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.ParsedResume, types.ParsedResume]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractProfile", args={
            "profile_text": profile_text,
        })
        return baml_py.BamlSyncStream[stream_types.ParsedResume, types.ParsedResume](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def ExtractProfile(self, profile_text: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ExtractProfile", args={
            "profile_text": profile_text,
        }, mode="request")
        return __result__
    def ExtractResume(self, resume_text: str,
